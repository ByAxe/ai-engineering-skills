...
Create `auth-submit-bugfix-scope-review.md` with the scope critique, the narrowed OpenSpec bugfix shape, the current/expected/unchanged behavior contract, and the verification plan. The grading expects that file as the solution artifact.
